...
import com.click.lib_banner.rvbanner.adapter.ComBaseAdapter;
 ...
 * @param <A>
 */
public abstract class ComRecyclerViewBannerBase<L extends RecyclerView.LayoutManager, A extends ComBaseAdapter> extends FrameLayout {
    ...
    public ComRecyclerViewBannerBase(Context context) {
        this(context, null);
    }

    public ComRecyclerViewBannerBase(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ComRecyclerViewBannerBase(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        autoPlayDuration = a.getInt(R.styleable.RecyclerViewBannerBase_interval, autoPlayDuration);
        ...
        new ComCustomSnapHelper().attachToRecyclerView(mRecyclerView);
